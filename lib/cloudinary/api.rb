...
class Cloudinary::Api
  ...
  def self.call_json_api(method, api_url, payload, timeout, headers, user = nil, password = nil)
  ...
  def self.call_cloudinary_api(method, uri, user, password, params, options, &api_url_builder)
  ...
  private_class_method :call_cloudinary_api
end
